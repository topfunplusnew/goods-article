...
import { getAboutDtos } from "@/server/repository";
...
export default async function AdminAboutPage() {
  ...
  return (
    <PageSection
      ...
      title={dictionary.admin.about_pages}
      description={dictionary.admin.about_storage_hint}
    >
      <AdminPagesManager
        initialPages={JSON.parse(JSON.stringify(getAboutDtos()))}
        resource="abouts"
        labels={{
          ...
          edit: dictionary.admin.edit_about_page,
